...
Rails::Initializer.run do |config|
  ...
  config.active_record.observers = :receipt_observer,:shippment_observer,:vip_fee_info_observer,:org_observer,:message_observer,:position_observer,:salary_table_observer
