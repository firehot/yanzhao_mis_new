...
class AddBillFunction < ActiveRecord::Migration
  def self.up
    ...
    sf.update_attributes(:system_function_cat => sfc,:func_name => "审核确认单",:group_name => "票据管理")
    ...
    sf.update_attributes(:system_function_cat => sfc,:func_name => "审核核销单",:group_name => "票据管理")
    ...
    sf.update_attributes(:system_function_cat => sfc,:func_name => "审核确认单",:group_name => "提货单管理")
    ...
    sf.update_attributes(:system_function_cat => sfc,:func_name => "审核核销单",:group_name => "提货单管理")
